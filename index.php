...
Seuls quelques groupes de personnes refusent encore la connexion au réseau Google universel. Marginalisés hors des canaux dominants de communication ces rebelles de l'intimité se trouvent pourtant impuissants face aux évolutions politiques qui les inquiètent.</p>
        ...
        <div class="marged" >
            <div class="boxes">
                ...
                <h3>Conférence d'ouverture </br>à la médiathèque <a href="http://www.mediatheques.strasbourg.eu/medias/medias.aspx?INSTANCE=EXPLOITATION&PORTAL_ID=WBCT_WBCTDOC_28.xml&SYNCMENU=INF_MED_MALRAUX"><strong>Malraux</strong></a></h3>
...
Léo Henry présentera ensuite deux nouvelles originales signées par le collectif d’auteurs francophones d’anticipation <a href="http://zanzibar.zone/"><span>Zanzibar</span></a>.</br>
